...
import { SNAPSHOT_SEED, REPORT_OPTIONS_SEED, AUTOMATION_SEED } from '../seeds/defaults.js?v=v2026-08-31.5';
import { normalizeDeltaMode } from '../model/delta-baseline.js?v=v2026-08-31.5';
...
import * as lock from './lock.js?v=v2026-08-31.5';
...
const REPORT_SLIDE_FIELDS = [
  ...
  { key: 'sendout', label: 'أين تُجرى الفحوصات — محلي مقابل دولي' },
