...
import { el, editableTable, textareaField, toast } from './components.js?v=v2026-09-08.1';
import { buildMockEngineOutput, buildMockTracker } from './screen-upload.js?v=v2026-09-08.1';
import { autoDraft, splitTaskLists } from '../model/drafts.js?v=v2026-09-08.1';
import { analyseSendout, hasMaster } from '../model/sendout.js?v=v2026-09-08.1';
import { buildHistoryPanel } from './history-table.js?v=v2026-09-08.1';
import {
  normalizeDeltaMode, isWeekDeltaMode, DEFAULT_DELTA_MODE,
} from '../model/delta-baseline.js?v=v2026-09-08.1';
...
} from '../model/task-lifecycle.js?v=v2026-09-08.1';
...
export async function render(container, ctx) {
  ...
  if (state.sendoutMaster === undefined) {
    ...
    const mod = await tryImport('../ingest/sendout-master.js?v=v2026-09-08.1');
  ...
  const dwMod = await tryImport('../model/delta-window.js?v=v2026-09-08.1');
  ...
  async function renderPreview() {
    ...
    const specMod = await tryImport('../slidespec/build-spec.js?v=v2026-09-08.1');
    const buildSpec = pickFn(specMod, ['buildSpec', 'build', 'makeSpec', 'toSpec']);
    const rendMod = await tryImport('../render/html-renderer.js?v=v2026-09-08.1');
