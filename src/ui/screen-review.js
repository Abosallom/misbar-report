...
import { el, editableTable, textareaField, toast } from './components.js?v=v2026-08-30.1';
...
import { buildHistoryPanel } from './history-table.js?v=v2026-08-30.1';
import {
  normalizeDeltaMode, isWeekDeltaMode, DEFAULT_DELTA_MODE,
} from '../model/delta-baseline.js?v=v2026-08-30.1';
...
} from '../model/task-lifecycle.js?v=v2026-08-30.1';
...
export async function render(container, ctx) {
  ...
  async function renderPreview() {
    ...
    const specMod = await tryImport('../slidespec/build-spec.js?v=v2026-08-30.1');
    const buildSpec = pickFn(specMod, ['buildSpec', 'build', 'makeSpec', 'toSpec']);
    const rendMod = await tryImport('../render/html-renderer.js?v=v2026-08-30.1');
