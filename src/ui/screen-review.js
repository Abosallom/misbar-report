...
import { el, editableTable, textareaField, toast } from './components.js?v=v2026-07-22.8';
...
export async function render(container, ctx) {
  ...
  async function renderPreview() {
    ...
    const specMod = await tryImport('../slidespec/build-spec.js?v=v2026-07-22.8');
    const buildSpec = pickFn(specMod, ['buildSpec', 'build', 'makeSpec', 'toSpec']);
    const rendMod = await tryImport('../render/html-renderer.js?v=v2026-07-22.8');
