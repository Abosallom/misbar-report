...
import { el, progressBar, toast } from './components.js?v=v2026-08-10.1';
import { resetRunData } from '../state.js?v=v2026-08-10.1';
...
import { buildLateLabsSection, triggerDownload } from './late-labs-section.js?v=v2026-08-10.1';
import {
  applyWindowDeltas, buildFileDefs, produceReportFiles, recordRunSnapshot,
  shouldAutoDownloadFiles,
} from '../automation/pipeline.js?v=v2026-08-10.1';
...
export async function render(container, ctx) {
  ...
  const dbMod = await tryImport('../model/delta-baseline.js?v=v2026-08-10.1');
  ...
  if (!produced.length) {
    ...
    const tlMod = await tryImport('../model/task-lifecycle.js?v=v2026-08-10.1');
    recordRunSnapshot({
