...
import { el, progressBar, toast } from './components.js?v=v2026-08-31.4';
import { resetRunData } from '../state.js?v=v2026-08-31.4';
...
import { buildLateLabsSection, triggerDownload } from './late-labs-section.js?v=v2026-08-31.4';
import {
  applyWindowDeltas, buildFileDefs, produceReportFiles, recordRunSnapshot,
  shouldAutoDownloadFiles,
} from '../automation/pipeline.js?v=v2026-08-31.4';
...
export async function render(container, ctx) {
  ...
  const dbMod = await tryImport('../model/delta-baseline.js?v=v2026-08-31.4');
  ...
  if (!produced.length) {
    ...
    const tlMod = await tryImport('../model/task-lifecycle.js?v=v2026-08-31.4');
    recordRunSnapshot({
