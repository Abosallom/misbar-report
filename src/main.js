...
import { state } from './state.js?v=v2026-08-04.1';
import { STR } from './i18n/ar.js?v=v2026-08-04.1';
import { APP_VERSION } from './version.js?v=v2026-08-04.1';
import { el, toast } from './ui/components.js?v=v2026-08-04.1';
...
import { HISTORICAL_CONSTANTS_SEED, SNAPSHOT_SEED, GRAFANA_SEED } from './seeds/defaults.js?v=v2026-08-04.1';
...
async function resolveStore() {
  ...
  let backend = null;
  try {
    const mod = await import('./store.js?v=v2026-08-04.1');
...
const SCREEN_MODULES = {
  upload: './ui/screen-upload.js?v=v2026-08-04.1',
  review: './ui/screen-review.js?v=v2026-08-04.1',
  generate: './ui/screen-generate.js?v=v2026-08-04.1',
  settings: './ui/screen-settings.js?v=v2026-08-04.1', // Track C
};
...
async function downloadAutoExtras(result) {
  ...
  let mod = null;
  try {
    mod = await import('./ui/late-labs-section.js?v=v2026-08-04.1');
  } catch (e) {
...
async function startAutomationRun(mode, store) {
  ...
  let mod = null;
  try {
    mod = await import('./automation/pipeline.js?v=v2026-08-04.1');
  } catch (e) {
...
async function boot() {
  ...
  try {
    lockMod = await import('./ui/lock.js?v=v2026-08-04.1');
...
function startApp(store) {
  ...
  state.onTatFileMerge = async (file) => {
    const [{ getXLSX }, { parseTatLookupXlsx }] = await Promise.all([
      import('./vendor-loader.js?v=v2026-08-04.1'),
      import('./ingest/xlsx.js?v=v2026-08-04.1'),
    ]);
  ...
  state.onGrafanaTest = async () => {
    try {
      const mod = await import('./ingest/grafana.js?v=v2026-08-04.1');
